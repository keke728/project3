...
var _resultsList = __webpack_require__(34);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function handleSubmit(event) {
      ...
      _axios2.default.get('https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=' + this.state.searchInput + '&origin=*&format=json').then(function (wikiData) {
        _this2.setState({
          searchResults: wikiData.data.query.search,
          spinnerStyle: { display: 'none' }
        });

        if (_this2.state.searchResults.length === 0) {
          _this2.setState({
            errorMessage: ' Unable to find results for "' + _this2.state.searchInput + '". Consider revising your search.',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'main',
          null,
          _react2.default.createElement('div', { className: 'fab fa-wikipedia-w fa-4x' }),
          _react2.default.createElement(
            'form',
            { role: 'search', onSubmit: function onSubmit(event) {
                return _this3.handleSubmit(event);
              } },
            _react2.default.createElement(
              'div',
              { className: 'form-group' },
              _react2.default.createElement('span', { className: 'fas fa-search' }),
              _react2.default.createElement('input', { type: 'search', className: 'search-input', 'aria-label': 'Search for a type of food...', placeholder: 'Search for the food...', onChange: function onChange(event) {
                  return _this3.handleChange(event);
                }, value: this.state.searchInput, required: true })
            )
          ),
          _react2.default.createElement(
            'div',
            { className: 'spinner', style: this.state.spinnerStyle },
            _react2.default.createElement('span', { className: 'fa fa-sync-alt fa-spin fa-2x fa-fw', 'aria-label': 'Loading...' })
          ),
          _react2.default.createElement(_resultsList2.default, { results: this.state.searchResults }),
          _react2.default.createElement(
            'p',
            { className: 'message error-message', style: this.state.errorStyle },
            _react2.default.createElement('span', { className: 'fa fa-exclamation-circle fa-lg fa-fw' }),
...
var _searchResult = __webpack_require__(35);
...
var ResultsList = function ResultsList(_ref) {
  ...
  var SearchResults = results.map(function (article, index) {
    return _react2.default.createElement(_searchResult2.default, { key: index, article: article });
  });
...
var SearchResult = function SearchResult(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement("p", { dangerouslySetInnerHTML: { __html: article.snippet + "..." } }),
    _react2.default.createElement(
      "p",
      null,
      _react2.default.createElement(
        "a",
        { href: "https://en.wikipedia.org/wiki/" + article.title, target: "_blank" },
        "Read More..."
      )
    )
  );
